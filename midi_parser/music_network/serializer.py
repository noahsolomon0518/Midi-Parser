...
#Data structure stored in MusicSampler and PickledMusicSampler 
...
#Also can save as PickledMusicSampler (MusicSampler without some atrributes)
...
class MusicSampler:
    ...
    #Appends GeneratedPiece to self which will eventually be passed to PickledMusicSampler
...
class PickledMusicSampler:
    ...
    #returns MusicSampler version of PickledMusicSampler
    #This is mainly for generating new music easily with saved PickledMusicSampler
    def getMusicSampler(self):
        return MusicSampler(self.getModel, self.trainingData)
