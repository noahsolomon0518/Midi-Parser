# -*- coding: utf-8 -*-
"""
Created on Tue Feb 23 11:06:08 2021
...
class NormalizedOTEncoder(OTEncoder):
    ...
    def encodeOneMido(self, OT):
        encodedOT = []
        for note in OT.notes:
            encodedOT.extend(NormalizedOTEncoder.encodeOneNote(note, OT.tpb, self.normalizationFactor))
